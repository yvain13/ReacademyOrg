...
export default function Home() {
  ...
  return (
    <div className="min-h-screen h-screen bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
      <Head>
        <title>Reacademy.ai - PDF to Flashcards</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className="h-full container mx-auto px-4 py-6 relative flex flex-col">
        ...
        <div className="flex gap-8 flex-1 min-h-0">
          ...
          <div className="w-1/2 flex flex-col min-h-0">
            ...
            {file && (
              <div className="flex-1 mt-4 backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-4 overflow-hidden">
          ...
          <div className="w-1/2 flex flex-col min-h-0">
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-6 flex-1 flex flex-col min-h-0">
              {/* Tabs */}
              ...
              {/* Cards Grid */}
              <div className="grid grid-cols-2 gap-4 overflow-y-auto flex-1 min-h-0 content-start">
                            ...
                            <div className="w-full h-full backdrop-blur-xl bg-white/5 rounded-xl p-6 flex items-center justify-center border border-white/10 hover:bg-white/10 transition-all duration-300 group">
                              <div className="relative w-full h-full flex items-center justify-center">
                                ...
                                <div className="text-center z-10 w-full">
                                  <div className="text-xs text-gray-400 mb-3 uppercase tracking-widest font-medium">Question</div>
                                  <p className="text-lg font-medium text-white/90 group-hover:text-white transition-colors duration-200 px-4">
                          ...
                          <div className="absolute w-full h-full backface-hidden rotate-y-180">
                            <div className="w-full h-full backdrop-blur-xl bg-white/10 rounded-xl p-6 flex items-center justify-center border border-white/20 hover:bg-white/15 transition-all duration-300 group">
                              <div className="relative w-full h-full flex items-center justify-center">
                                ...
                                <div className="text-center z-10 w-full">
                                  <div className="text-xs text-gray-400 mb-3 uppercase tracking-widest font-medium">Answer</div>
                                  <p className="text-lg text-white/90 group-hover:text-white transition-colors duration-200 px-4">
